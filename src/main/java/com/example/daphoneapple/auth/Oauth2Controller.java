...
import com.example.daphoneapple.model.TokenDto;
...
//		else {
//			usuario.setEmail(auth);
//			usuario.setUserRole(false);
			usuario.setUsername(payload.getEmail());
			usuario.setPassword(commonUtils.Sha1EncryptText(secretPsw));
...
//		}
		...
		return new ResponseEntity<LoginResponse>(new LoginResponse(auth, usuario.getUsername()),HttpStatus.OK);
	}
